          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            <div className="w-full md:w-1/2 space-y-6">
              <div className="inline-block px-3 py-1 bg-brand-gold/20 border border-brand-gold/30 rounded-full">
                <span className="text-brand-gold text-xs font-bold uppercase tracking-wider">Advocacia Especializada</span>
              </div>
      ...
      <section className="py-16 bg-brand-navy">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-slate-300 mb-8 max-w-2xl mx-auto">
            Cada dia com o nome sujo ou pagando juros abusivos é dinheiro perdido. Fale com um advogado agora mesmo.
          </p>
