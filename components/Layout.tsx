  ...
  return (
    <div className="flex flex-col min-h-screen">
        ...
        <div className="container mx-auto px-4 py-3 flex justify-between items-center">
          <Link to="/" className="flex items-center space-x-2 group">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-xs text-slate-400 font-light">Advocacia ao seu alcance</span>
            </div>
          </Link>
      ...
      <footer className="bg-slate-900 text-slate-400 py-10">
        <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-sm mb-2 flex items-center gap-2"><Phone size={16}/> (11) 99999-9999</p>
      ...
      >
        ...
        <span className="hidden md:inline font-bold">Falar com Advogado</span>
      </a>
    </div>
  );
};
